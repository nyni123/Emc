...
include('cit_connect.php');
 ...
 $conn=  mysqli_query($conn, "select * from app");
//or die(mysql_error());
...
<th><font color='white'>Voter</font></th>
...
echo '<td><b><font color="#663300">' . $row['Father Name'] . '</font></b></td>';
echo '<td><b><font color="#663300">' . $row['Voter'] . '</font></b></td>';
echo '<td><b><font color="#663300">' . $row['Dob'] . '</font></b></td>';
//echo '<td><b><font color="#663300"><a href="edit.php?id=' . $row['id'] . '">Edit</a></font></b></td>';
echo '<td><b><font color="lightblue"><a href="cit_delete.php?Voter=' . $row['Voter'] . '">Delete</a></font></b></td>';
echo "</tr>";
